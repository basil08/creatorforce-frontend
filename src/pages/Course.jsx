...
export default function CoursePage() {
  ...
  const course  = {title : "COL202", description : "Discrete Math Structures", livelec : true, startTime : new Date("02/01/2022"), endTime : new Date("03/01/2022")}
                ...
                {course.livelec &&
                  <Flex p="4">
                    ...
                    <Flex
                          ...
                          m="4"
                        >
                          <Button size="lg" colorScheme={'blue'} onClick={()=>navigate(`/liveexcourse/${course.id}`)}>
                    ...
                    <Flex
                          ...
                          m="4"
                        >
                          <Button size="lg" colorScheme={'gray'} onClick={()=>navigate("/newwebinar")}>
                            Join Live Lecture
                          </Button>
                        </Flex>
                  ...
                  <Flex
                          ...
                          m="4"
                        >
                          <Button size="lg" colorScheme={'blue'} onClick={()=>navigate(`/uploadexcourse/${course.id}`)}>
                            Upload New Lecture
                          </Button>
                 </Flex>
