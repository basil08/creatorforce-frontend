...
export default function CoursePageUser() {
  ...
  const course  = {title : "COL202", description : "Discrete Math Structures", reclec : true, startTime : new Date("02/01/2022"), endTime : new Date("03/01/2022"), lecs : [{"name": "COL202", "description": "stillhere"}]}
            ...
            <Flex p="4" fontSize={26}>
              ...
              <Text> {course.description}</Text>
                ...
                {course.livelec &&
                  ...
                  {course.reclec && <Flex p="4"><Text>This course has recorded lectures </Text>
